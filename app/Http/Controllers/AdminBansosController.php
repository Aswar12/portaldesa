...
class AdminBansosController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'jenis_bansos.required'     => 'Jenis bantuan sosial harus dipilih.',
            'jumlah_penerima.required'  => 'Jumlah penerima harus diisi.',
            'jumlah_penerima.integer'   => 'Jumlah penerima harus berupa angka.',
            'jumlah_penerima.min'       => 'Jumlah penerima tidak boleh negatif.',
            ...
            'periode_mulai.date'        => 'Format tanggal periode mulai tidak valid.',
            'periode_selesai.date'      => 'Format tanggal periode selesai tidak valid.',
