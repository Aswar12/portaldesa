...
<div class="card bg-light-info shadow-none position-relative overflow-hidden">
    <div class="card-body px-4 py-3">
        <div class="row align-items-center">
            <div class="col-9">
                <h4 class="fw-semibold mb-8">Tambah Data Bansos</h4>
...
<div class="card">
    <div class="card-body">
        <h5 class="card-title fw-semibold mb-4">Form Tambah Bantuan Sosial</h5>
        
        <form action="{{ route('admin.bansos.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control @error('jenis_bansos') is-invalid @enderror" 
                            ...
                            @foreach($jenisBansosOptions as $key => $value)
                                <option value="{{ $key }}" {{ old('jenis_bansos') == $key ? 'selected' : '' }}>
                                    {{ $value }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="col-lg-12">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('keterangan') is-invalid @enderror" 
                                  ...
                                  name="keterangan" 
                                  rows="3"
                                  placeholder="Keterangan atau deskripsi tambahan...">{{ old('keterangan') }}</textarea>
                        @error('keterangan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
