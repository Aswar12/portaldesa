...
@section('content')
            ...
            <div class="card w-100">
                <div class="card-header bg-primary">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <h5 class="card-title fw-semibold text-white">Edit Data Stunting</h5>
                        </div>
    ...
    <div class="row">
        <form method="POST" action="/admin/stunting/{{ $stunting->id }}" enctype="multipart/form-data">
            @method('put')
            @csrf
            <div class="row">
                <div class="col-lg-8">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('judul') is-invalid @enderror" 
                                       name="judul" id="judul" value="{{ old('judul', $stunting->judul) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="color" class="form-control form-control-color" 
                                               name="warna_chart" id="warna_chart" value="{{ old('warna_chart', $stunting->warna_chart ?? '#ff6b6b') }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control @error('balita_normal') is-invalid @enderror" 
                                                       name="balita_normal" id="balita_normal" value="{{ old('balita_normal', $stunting->balita_normal) }}" min="0">
                                                @error('balita_normal')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control @error('balita_stunting') is-invalid @enderror" 
                                                       name="balita_stunting" id="balita_stunting" value="{{ old('balita_stunting', $stunting->balita_stunting) }}" min="0">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control @error('balita_kurus') is-invalid @enderror" 
                                                       name="balita_kurus" id="balita_kurus" value="{{ old('balita_kurus', $stunting->balita_kurus) }}" min="0">
                                                @error('balita_kurus')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control @error('balita_gemuk') is-invalid @enderror" 
                                                       name="balita_gemuk" id="balita_gemuk" value="{{ old('balita_gemuk', $stunting->balita_gemuk) }}" min="0">
                                                @error('balita_gemuk')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="alert alert-info">
                                        <i class="fas fa-info-circle"></i> <strong>Total Balita:</strong> <span id="total_balita">{{ $stunting->total_balita }}</span>
                                        <br><small>
                                            Normal: {{ $stunting->persentase_normal }}% | 
                                            Stunting: {{ $stunting->persentase_stunting }}% | 
                                            Kurus: {{ $stunting->persentase_kurus }}% | 
                                            Gemuk: {{ $stunting->persentase_gemuk }}%
                                        </small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('keterangan') is-invalid @enderror" 
                                          ...
                                          placeholder="Keterangan tambahan tentang data stunting">{{ old('keterangan', $stunting->keterangan) }}</textarea>
                                @error('keterangan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3">
                                @if($stunting->gambar)
                                    <img src="{{ asset('storage/' . $stunting->gambar) }}" 
                                         class="img-fluid mb-3 current-image rounded" 
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" 
                                                   ...
                                                   {{ old('tampil_infografis', $stunting->tampil_infografis) ? 'checked' : '' }}>
                            ...
                            <button type="submit" class="btn btn-primary w-100 mt-3">
                                <i class="fas fa-save me-2"></i>Update Data Stunting
                            </button>
                        </div>
                    </div>
                </div>
