...
<div class="row">
    <div class="col-lg-12 d-flex align-items-strech">
        <div class="card w-100">
            <div class="card-header bg-primary">
                <div class="row align-items-center">
                    ...
                    <div class="col-6 text-right">
                        <a href="{{ route('admin.idm.index') }}" type="button" class="btn btn-warning float-end">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.idm.store') }}">
                    @csrf
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('tahun') is-invalid @enderror" 
                                       name="tahun" id="tahun" value="{{ old('tahun', date('Y')) }}" 
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.0001" min="0" max="1" 
                                       ...
                                       name="skor_idm" id="skor_idm" value="{{ old('skor_idm') }}" 
                                       placeholder="0.0000">
                                @error('skor_idm')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control @error('target_status') is-invalid @enderror" name="target_status" id="target_status">
                                    ...
                                    <option value="MANDIRI" {{ old('target_status') == 'MANDIRI' ? 'selected' : '' }}>MANDIRI</option>
                                    <option value="MAJU" {{ old('target_status') == 'MAJU' ? 'selected' : '' }}>MAJU</option>
                                    <option value="BERKEMBANG" {{ old('target_status') == 'BERKEMBANG' ? 'selected' : '' }}>BERKEMBANG</option>
                                </select>
                                @error('target_status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.0001" min="0" max="1" 
                                       ...
                                       name="skor_minimal" id="skor_minimal" value="{{ old('skor_minimal') }}" 
                                       placeholder="0.0000">
                                @error('skor_minimal')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.0001" 
                                       ...
                                       name="penambahan" id="penambahan" value="{{ old('penambahan') }}" 
                                       placeholder="0.0000">
                                @error('penambahan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.0001" min="0" max="1" 
                                       ...
                                       name="skor_iks" id="skor_iks" value="{{ old('skor_iks') }}" 
                                       placeholder="0.0000">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.0001" min="0" max="1" 
                                       ...
                                       name="skor_ike" id="skor_ike" value="{{ old('skor_ike') }}" 
                                       placeholder="0.0000">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.0001" min="0" max="1" 
                                       ...
                                       name="skor_ikl" id="skor_ikl" value="{{ old('skor_ikl') }}" 
                                       placeholder="0.0000">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('deskripsi') is-invalid @enderror" 
                                          ...
                                          placeholder="Deskripsi tambahan tentang data IDM tahun ini...">{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
