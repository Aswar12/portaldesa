...
@section('content')
            ...
            <div class="card w-100">
                <div class="card-header bg-primary">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <h5 class="card-title fw-semibold text-white">Tambah Data SDGS</h5>
                        </div>
    ...
    <div class="row">
        <form method="POST" action="{{ route('admin.sdgs.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label for="judul" class="form-label">Judul/Nama Program <span style="color: red">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('target_1') is-invalid @enderror" 
                                            ...
                                            @for($i = 1; $i <= 5; $i++)
                                                <option value="{{ $i }}" {{ old('target_1') == $i ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('target_2') is-invalid @enderror" 
                                            ...
                                            <option value="">Pilih Skor</option>
                                            @for($i = 1; $i <= 5; $i++)
                                                <option value="{{ $i }}" {{ old('target_2') == $i ? 'selected' : '' }}>
                                                    {{ $i }} - {{ $i == 1 ? 'Sangat Kurang' : ($i == 2 ? 'Kurang' : ($i == 3 ? 'Sedang' : ($i == 4 ? 'Baik' : 'Sangat Baik'))) }}
                                                </option>
                                            @endfor
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('target_3') is-invalid @enderror" 
                                            ...
                                            <option value="">Pilih Skor</option>
                                            @for($i = 1; $i <= 5; $i++)
                                                <option value="{{ $i }}" {{ old('target_3') == $i ? 'selected' : '' }}>
                                                    {{ $i }} - {{ $i == 1 ? 'Sangat Kurang' : ($i == 2 ? 'Kurang' : ($i == 3 ? 'Sedang' : ($i == 4 ? 'Baik' : 'Sangat Baik'))) }}
                                                </option>
                                            @endfor
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('target_4') is-invalid @enderror" 
                                            ...
                                            <option value="">Pilih Skor</option>
                                            @for($i = 1; $i <= 5; $i++)
                                                <option value="{{ $i }}" {{ old('target_4') == $i ? 'selected' : '' }}>
                                                    {{ $i }} - {{ $i == 1 ? 'Sangat Kurang' : ($i == 2 ? 'Kurang' : ($i == 3 ? 'Sedang' : ($i == 4 ? 'Baik' : 'Sangat Baik'))) }}
                                                </option>
                                            @endfor
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('target_5') is-invalid @enderror" 
                                            ...
                                            <option value="">Pilih Skor</option>
                                            @for($i = 1; $i <= 5; $i++)
                                                <option value="{{ $i }}" {{ old('target_5') == $i ? 'selected' : '' }}>
                                                    {{ $i }} - {{ $i == 1 ? 'Sangat Kurang' : ($i == 2 ? 'Kurang' : ($i == 3 ? 'Sedang' : ($i == 4 ? 'Baik' : 'Sangat Baik'))) }}
                                                </option>
                                            @endfor
                                        </select>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="color" class="form-control form-control-color @error('warna_chart') is-invalid @enderror" 
                                       id="warna_chart" name="warna_chart" value="{{ old('warna_chart', '#6f42c1') }}">
                                @error('warna_chart')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div id="previewContent">
                                <div class="text-center">
                                    <div class="display-6 fw-bold text-primary" id="avgScore">0.0</div>
                                    <small class="text-muted">Rata-rata</small>
                                    <div class="mt-2">
                                        <span class="badge bg-secondary" id="statusBadge">Belum Ada Data</span>
                                    </div>
                                </div>
                            </div>
                        </div>
